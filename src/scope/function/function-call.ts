...
export class FunctionCall extends Element {
    ...
    public constructor(name: string, nameInterval: Interval, scope: Scope, interval: Interval, logicalFunction: LogicalFunction, builtin: boolean, incomingCall: FunctionDeclaration) {
