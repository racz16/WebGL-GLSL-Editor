...
export const variables = new Map<string, Array<IVariable>>([
  [
    "100",
    [
      {
      ...
      {
        summary: "Depth range in window coordinates.",
        notDocumented: true,
  ...
  [
    ...
    [
      ...
      },
      {
        min: 16,
        type: "int",
        name: "gl_MaxVertexOutputVectors",
        qualifiers: ["const", "mediump"],
      },
      {
        min: 15,
        type: "int",
        name: "gl_MaxFragmentInputVectors",
        qualifiers: ["const", "mediump"],
      },
      {
        min: 16,
